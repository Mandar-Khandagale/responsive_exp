...
class _SecondPageScreenState extends State<SecondPageScreen> {
  ...
  Widget build(BuildContext context) {
    return Device.orientation == Orientation.portrait ? _widPortrait() : _widLandScape();
  }
...
//landscape
  ...
  _widTitleLand() {
    return Padding(
      ...
      child: const Text("wdwadawd"),
    );
  }

  _widDescLand() {
    return Padding(padding: EdgeInsets.only(right: 25.w, left: 25.w, top: 1.5.h), child: const Text('dwadwad'));
  }
}